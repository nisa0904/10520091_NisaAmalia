                ...
                <form action="{{url('produk/create', @$produk->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select name="kategori_produk" id="kategori_produk" class="form-control">
                                ...
                                <option @selected(old('kategori_produk', @$produk->kategori_produk) == 'TM.08.1.A.1') value="TM.08.1.A.1">TM.08.1.A.1</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            ...
                            @endif
                            <input type="file" class="form-control" name="foto_produk" id="foto-produk">
                        </div>
                    </div>
